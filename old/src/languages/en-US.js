...
module.exports = class extends Language {
	constructor (...args) {
		...
		this.language = {
			...
			// #region Regex
			COMMAND_REGEX_ADD_DESCRIPTION: "Adds a regex or multiple regexes to your highlight list",
			COMMAND_REGEX_ADD_EXTENDED: [
				"This command allows you to add any regex you want to your list, with a cap of 6 total regexes.",
				"Should you hit that limit, spend some time combining regexes together!",
				"",
				"",
				"Examples (`<prefix> is your server prefix, or a bot mention`)",
				"`<prefix>addregex wow?`",
				"This will match any messages that have `wow` or `wo`",
				"If your regex contains spaces, wrap it around quotes",
				'`<prefix>addregex "wait ?spaces *woah"`',
				"",
				"If you want to test your regular expression, please visit <https://regexr.com>",
			].join("\n"),
			// #endregion
		};
	}
